...
const Login = () => {
    ...
    const submitHandler=async (e)=>{
        ...
        try {
            ...
            const redirectError=sp.get('redirect')|| '/login'
        ...
        <div className="mr-[4rem] mt-[5rem]">
            ...
            <form onSubmit={submitHandler} className="container w=[40rem">
                <div className="my-[2rem]">
                    <label htmlFor="email" className="black text-sm font-medium text-white">Email Address</label>
                ...
                <div className="my-[2rem]">
                    <label htmlFor="password" className="black text-sm font-medium text-white">Password</label>
                ...
                <button type='submit' className="bg-pink-500 text-white px-4 py-2 rounded cursor-pointer my-[1rem">{isLoading?"Signing In...":"Sign In"}</button>
                {isLoading &&<Loader/>}
            </form>
            <div className="mt-4">
